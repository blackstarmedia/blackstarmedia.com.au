/**
 * Black Star Media — Lip Sync Poster Email Delivery
 * ==================================================
 * A Google Apps Script web app that powers the email capture on
 * lip-sync-poster.html. When a visitor submits their email it:
 ...
 *    Name it "Black Star — Lip Sync Poster Delivery".
...
var CONFIG = {
  ...
  PDF_URL:      "https://blackstarmedia.com.au/assets/pdf/100-percent-perfect-lip-sync.pdf",
  PDF_FILENAME: "100-Percent-Perfect-Lip-Sync.pdf",
  PDF_TITLE:    "100% Perfect Lip Sync",

  // Leave blank to auto-create a Sheet on first run.
  SHEET_ID:   "",
  SHEET_NAME: "Lip Sync Poster Signups",
...
function doGet() {
  return json_({ ok: true, service: "lip-sync-poster-delivery" });
}
...
function getSheet_() {
  ...
  var id    = CONFIG.SHEET_ID || props.getProperty("LIP_SYNC_SHEET_ID");
  var ss;
  if (id) {
    ss = SpreadsheetApp.openById(id);
  } else {
    ss = SpreadsheetApp.create("Black Star — Lip Sync Poster Signups");
    props.setProperty("LIP_SYNC_SHEET_ID", ss.getId());
  }
...
function sendEmail_(email) {
  ...
  var downloadLink = CONFIG.SITE_URL + "/assets/pdf/100-percent-perfect-lip-sync.pdf";
  ...
  var plain =
    ...
    "I hope it’s genuinely useful. If you want to go deeper on AI video tools, " +
  ...
  var html =
    '<div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;' +
      ...
      '<div style="padding:28px 8px;">' +
        ...
        '<p>If you want to go deeper on AI video tools, our ' +
